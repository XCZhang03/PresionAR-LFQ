...
#SBATCH --job-name=vae-2-ft-xs_lr
...
srun bash -c "
    ...
    experiment.vqgan_checkpoint=/n/holylabs/ydu_lab/Lab/zhangxiangcheng/code/PresionAR-LFQ/ckpts/maskbit_tokenizer_10bit.bin \
    ${MODEL_ARGS} \
    "
